...
export const selectBeginDate = (state: RootState) =>
  state.calendar.actions.beginDate;
export const selectCountDay = (state: RootState) =>
  state.calendar.actions.countDay;
export const selectObjects = (state: RootState) => state.calendar.rooms;
export const selectCurrentWidth = (state: RootState) =>
  state.calendar.common.currentWidth;
export const selectCommonSettings = (state: RootState) => state.calendar.common;
